  ...
  return (
    <SafeAreaView style={Styles.container}>
      ...
      <Map map={IMAGES.mapHeritage} >
        ...
        <MapText text={'Hotel adi mulia'} image={IMAGES.adiMulia} top={mapHeight/4} left={mapWidth/6} action={() => setPopUp(true)} />
        <MapText text={'Hotel adi mulia'} image={IMAGES.adiMulia} top={mapHeight/2.4} left={mapWidth/2.8} action={() => setPopUp(true)} />
        <MapText text={'Hotel adi mulia'} image={IMAGES.adiMulia} top={mapHeight/1.8} left={mapWidth/2.2} action={() => setPopUp(true)} />
        <MapText text={'Hotel adi mulia'} image={IMAGES.adiMulia} top={mapHeight/7} left={mapWidth/2.9} action={() => setPopUp(true)} />
        <MapText text={'Hotel adi mulia'} image={IMAGES.adiMulia} top={mapHeight/1.35} left={mapWidth/1.6} action={() => setPopUp(true)} />
        <MapText text={'Hotel adi mulia'} image={IMAGES.adiMulia} top={mapHeight/2.7} left={mapWidth/1.6} action={() => setPopUp(true)} />
