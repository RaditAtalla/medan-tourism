...
import { transportMetrodeliData as DATA } from '../../utils/dataDummy'
          ...
          <View style={styles.container}>
            <View style={styles.content}>
              ...
              <View style={styles.menuWrapper}>
                ...
                <View>
                  {DATA.map((item, index) => (
                    <View key={index} style={[styles.menu, styles[`menu${item.koridorNumber}`]]}>
                      <KoridorCard
                        trekText={item.trek}
                        koridorNumber={item.koridorNumber}
